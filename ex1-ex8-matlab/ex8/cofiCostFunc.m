...
X = reshape(params(1:num_movies*num_features), num_movies, num_features);% 1682*5
Theta = reshape(params(num_movies*num_features+1:end), ...
                num_users, num_features);% 943*5

            
% You need to return the following values correctly
J = 0;
X_grad = zeros(size(X));% 1682*5
Theta_grad = zeros(size(Theta));% 943*5
